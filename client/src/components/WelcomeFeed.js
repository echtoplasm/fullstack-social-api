    ...
    <div style={{ gridArea: 'feed' }}>
      <div className="rounded shadow-sm" style={{ overflow: "hidden" }}>
        <div className="d-flex align-items-center justify-content-center">
          <p className="mt-3 text-center fs-5 card w-50 welcome-message-feed">We have provided a live feed of some of our members posts to give you a better idea of what to expect here at Heap Social</p>
        </div>
        ...
        <h2 className='text-center card-title-bg text-white p-2 mb-0'>Members Posts</h2>
        <div style={{
          minHeight: '400px',
          maxHeight: '600px',
          overflowY: 'auto',
